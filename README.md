...
**Framework and motivation.** Direct prompting can rely on unsupported parametric recall, memory augmentation may introduce hindsight, and conventional RAG can retrieve temporally invalid documents. TIEM instead constructs temporally valid event evidence, retrieves causal skills learned only from already resolved events, and jointly reasons over structured evidence and experience to produce an auditable direction forecast.
