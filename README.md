...
[![Paper](https://img.shields.io/badge/Paper-PDF-b31b1b.svg)](static/pdfs/TIEM_NAACL.pdf)
[![Python](https://img.shields.io/badge/Python-3.10%2B-3776AB.svg?logo=python&logoColor=white)](https://www.python.org/)
[![Task](https://img.shields.io/badge/Task-Financial%20Forecasting-2F80ED.svg)](#overview)

### **TIEM**: Temporal Integration of Hypergraph Evidence and Skill Memory for Event-Driven Financial Forecasting

[Paper](static/pdfs/TIEM_NAACL.pdf) · [Overview](#overview) · [Quick Start](#quick-start) · [Evaluation](#evaluation)
...
<div align="center">
  <img src="static/images/tiem-framework.png" width="92%" alt="Overview of the TIEM framework"/>
</div>

**Framework.** TIEM first constructs temporally valid event evidence, retrieves causal skills learned only from already resolved events, and then fuses evidence with experience to produce an auditable direction forecast.

<div align="center">
  <img src="static/images/tiem-baseline-comparison.png" width="92%" alt="Comparison between direct prompting, memory augmentation, RAG, and TIEM"/>
</div>

**Why TIEM?** Direct prompting can rely on unsupported parametric recall, memory augmentation may introduce hindsight, and conventional RAG can retrieve temporally invalid documents. TIEM applies explicit point-in-time gates and jointly reasons over structured evidence and causal experience.

<div align="center">
  <img src="static/images/tiem-benchmark-and-cip.png" width="92%" alt="Catalyst-outcome benchmarks and the contamination inspection protocol"/>
</div>
...
<div align="center">
  <img src="static/images/tiem-point-in-time-forecasting.png" width="92%" alt="Point-in-time catalyst-outcome forecasting task"/>
</div>
...
├── static/                # Paper figures, PDF, and presentation assets
├── requirements.txt
└── README.md
```
...
- [Full paper (PDF)](static/pdfs/TIEM_NAACL.pdf)
- [Static assets and figure guide](static/README.md)
